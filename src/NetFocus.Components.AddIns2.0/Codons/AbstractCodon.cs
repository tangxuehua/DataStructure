...
namespace NetFocus.Components.AddIns.Codons
{
	...
	public abstract class AbstractCodon : ICodon
	{
		...
		public string CodonType {
			get {
				string codonType = null;
				CodonAttribute codonTypeAttribute = (CodonAttribute)Attribute.GetCustomAttribute(GetType(), typeof(CodonAttribute));
				if (codonTypeAttribute != null) {
