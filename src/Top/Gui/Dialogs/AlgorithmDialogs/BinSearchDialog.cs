...
{
	public class BinSearchDialog : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtSourceString.TabIndex = 20;
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			if(CheckAvailable() == true)
			{
				...
				if(algorithm != null)
				{
					algorithm.Status = new BinSearchStatus(s,Char.Parse(c));
				}
		...
		private void SaveStatus()
		{
			...
			{
				if(el.Attributes["name"].Value == typeof(BinSearch).ToString())
				{
