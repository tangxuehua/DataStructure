...
{
	public class SequenceInsertDialog : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "SequenceInsertDialog";
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			if(CheckAvailable() == true)
			{
				...
				if(algorithm != null)
				{
					algorithm.Status = new SequenceInsertStatus(s,Int32.Parse(p),Char.Parse(c));
				}
		...
		private void SaveStatus()
		{
			...
			{
				if(el.Attributes["name"].Value == typeof(SequenceInsert).ToString())
				{
