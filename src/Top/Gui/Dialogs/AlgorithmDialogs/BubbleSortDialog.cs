...
{
	public class BubbleSortDialog : System.Windows.Forms.Form
	{
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			if(algorithm != null)
			{
				algorithm.Status = new BubbleSortStatus(s);
			}
		...
		private void SaveStatus()
		{
			...
			{
				if(el.Attributes["name"].Value == typeof(BubbleSort).ToString())
				{
