...
{
	public class CreateListDialog : System.Windows.Forms.Form
	{
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			if(algorithm != null)
			{
				algorithm.Status = new CreateListStatus(s);
			}
		...
		private void SaveStatus()
		{
			...
			{
				if(el.Attributes["name"].Value == typeof(CreateList).ToString())
				{
			...
			if(parentNode != null)
			{
				...
				childNode.SetAttribute("ListString",s);
