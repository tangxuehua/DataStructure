...
{
	public class ListDeleteDialog : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtSourceString.MaxLength = 10;
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			if(CheckAvailable() == true)
			{
				...
				if(algorithm != null)
				{
					algorithm.Status = new ListDeleteStatus(s,Int32.Parse(p));
				}
		...
		private void SaveStatus()
		{
			...
			{
				if(el.Attributes["name"].Value == typeof(ListDelete).ToString())
				{
