...
{
	public class OneQuickPassDialog : System.Windows.Forms.Form
	{
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			if(algorithm != null)
			{
				algorithm.Status = new QuickSortStatus(s,1,s.Length);
			}
		...
		private void SaveStatus()
		{
			...
			{
				if(el.Attributes["name"].Value == typeof(OneQuickPass).ToString())
				{
