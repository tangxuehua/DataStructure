...
namespace NetFocus.DataStructure.Gui.Views
{
	...
	#region a inter operation class
	...
	public class HtmlViewControl : UserControl
	{
	...
	public class HtmlView : AbstractViewContent
	{
		protected HtmlViewControl htmlViewControl;
		
		public override Control Control 
		{
			get 
			{
				return htmlViewControl;
			}
		}
		...
		protected HtmlView(bool showNavigation)
		{
			ContentName = "技术支持";
			htmlViewControl = new HtmlViewControl(showNavigation);
			htmlViewControl.AxWebBrowser.TitleChange += new DWebBrowserEvents2_TitleChangeEventHandler(TitleChange);
		}
		
		public HtmlView() : this(true)
		{
		}
		
		public override void Dispose()
		{
			htmlViewControl.Dispose();
		}
		
		public override void SelectView()
		{
			htmlViewControl.Focus();
			OnViewSelected(null);
		}
