		...
		public void Draw(Graphics g)
		{
			...
			switch(appearance)
			{
				...
				case GlyphAppearance.Popup:
					...
					g.DrawLine(new Pen(Color.Gray,1),this.x ,this.y + this.height,this.x + this.width,this.y + this.height);//下边框;
					g.DrawLine(new Pen(Color.Gray,1),this.x + this.width,this.y,this.x + this.width,this.y + this.height);//右边框;
					break;
			}
		}
