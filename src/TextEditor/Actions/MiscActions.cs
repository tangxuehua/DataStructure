...
//						textArea.Document.RequestUpdate(new TextAreaUpdate(TextAreaUpdateType.PositionToLineEnd, new Point(textArea.Caret.Offset - textArea.Document.GetLineSegment(curLineNr).Offset, curLineNr)));
	...
	public class MovePageDown : AbstractEditAction
	{
		...
		public override void Execute(TextArea textArea)
		{
			...
			int requestedLineNumber = Math.Min(textArea.Document.GetNextVisibleLineAbove(curLineNr, textArea.TextViewMargin.VisibleLineCount), textArea.Document.TotalNumberOfLines - 1);
	...
	public class MovePageUp : AbstractEditAction
	{
		...
		{
			int curLineNr           = textArea.Caret.Line;
			int requestedLineNumber = Math.Max(textArea.Document.GetNextVisibleLineBelow(curLineNr, textArea.TextViewMargin.VisibleLineCount), 0);
	...
	public class GotoMatchingBrace : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
			if (textArea.TextViewMargin.Highlight != null) {
				Point p1 = new Point(textArea.TextViewMargin.Highlight.CloseBrace.X + 1, textArea.TextViewMargin.Highlight.CloseBrace.Y);
				Point p2 = new Point(textArea.TextViewMargin.Highlight.OpenBrace.X + 1, textArea.TextViewMargin.Highlight.OpenBrace.Y);
