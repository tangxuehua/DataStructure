...
namespace NetFocus.DataStructure.TextEditor
{
	public class TextAreaDragDropHandler
	{
		...
		protected void OnDragOver(object sender, DragEventArgs e)
		{
			...
			if (textArea.TextViewMargin.DrawingRectangle.Contains(p.X, p.Y)) {
				Point realmousepos= textArea.TextViewMargin.GetLogicalPosition(p.X - textArea.TextViewMargin.DrawingRectangle.X,
				                                                         p.Y - textArea.TextViewMargin.DrawingRectangle.Y);
