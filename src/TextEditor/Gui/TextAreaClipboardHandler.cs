...
//			((DefaultWorkbench)WorkbenchSingleton.Workbench).UpdateToolbars();
		...
		{
			new NetFocus.DataStructure.TextEditor.Actions.Delete().Execute(textArea);
		}
		
		public void SelectAll(object sender, EventArgs e)
		{
			new NetFocus.DataStructure.TextEditor.Actions.SelectWholeDocument().Execute(textArea);
		}
